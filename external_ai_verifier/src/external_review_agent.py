...
class ExternalReviewAgent:
    ...
    def find_consolidacao_file(self, session_id: str) -> Optional[str]:
        ...
        try:
            # DiretÃ³rio base onde os arquivos sÃ£o salvos
            base_paths = [
            ...
            for base_path in base_paths:
                if os.path.exists(base_path):
                    # Busca por arquivos de consolidaÃ§Ã£o
    ...
    def analyze_session_consolidacao(self, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not consolidacao_data:
                return {
                    'success': False,
                    'error': f'Arquivo de consolidaÃ§Ã£o nÃ£o encontrado para sessÃ£o {session_id}',
                    'session_id': session_id,
                    'timestamp': datetime.now().isoformat()
                }
